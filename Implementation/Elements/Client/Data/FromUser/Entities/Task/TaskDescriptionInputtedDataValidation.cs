...
internal class TaskDescriptionInputtedDataValidation : InputtedValueValidation
{
  ...
  internal TaskDescriptionInputtedDataValidation(
    bool? isInputRequired = CommonSolution.Entities.Task.Task.Description.IS_REQUIRED,
    ...
    [
      ...
      {
        MinimalCharactersCount = CommonSolution.Entities.Task.Task.Description.MINIMAL_CHARACTERS_COUNT,
        ErrorMessage = $"課題の詳細は最少{ CommonSolution.Entities.Task.Task.Description.MINIMAL_CHARACTERS_COUNT }を指定して下さい。",
